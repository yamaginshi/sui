...
use crate::crypto::{get_key_pair, DefaultAccountKeyPair, AuthorityKeyPair, AuthorityPublicKeyBytes};
...
fn test_digest_caching() {
    ...
    let (sa1, _ssec1): (_, narwhal_crypto::ed25519::Ed25519KeyPair) = get_key_pair();
    let (sa2, ssec2): (_, narwhal_crypto::ed25519::Ed25519KeyPair) = get_key_pair();
